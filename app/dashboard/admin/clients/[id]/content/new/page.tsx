...
export default function AdminNewContentPage() {
  ...
  const fetchData = async () => {
    try {
      // Fetch client, pillars, and products in parallel
  ...
  const generateTopicSuggestions = useCallback(async () => {
    if (!clientId || loadingTopics) return;
  ...
  }, [clientId, formData, pillars, products, cachedContext, loadingTopics]);
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (data.success && data.id) {
        // Redirect to content detail page (admin can view client's content)
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Buat Konten untuk {client?.businessName || "Client"}</h1>
      ...
      <div className="glass-card rounded-2xl p-8 mb-6">
        ...
        {step === 1 && (
          <div className="animate-fade-in">
            ...
            <p className="text-slate-500 mb-6">Tentukan jenis konten yang ingin dibuat untuk client</p>
        ...
        {step === 2 && (
          <div className="animate-fade-in">
            ...
            <p className="text-sm text-slate-400 mt-4 text-center">
              Bisa pilih satu atau kedua platform
            </p>
          </div>
        )}
          ...
          <div className="animate-fade-in">
            ...
            {products.length > 0 && (
              <>
                ...
                <p className="text-sm text-slate-400 mt-4 text-center">
                  Bisa pilih lebih dari satu produk
                </p>
              </>
            )}
            ...
            {products.length === 0 && (
              <div className="text-center py-4 text-slate-500 text-sm">
                <p>Belum ada produk yang ditambahkan untuk client ini.</p>
                <Link href={`/dashboard/admin/clients/${clientId}/products`} className="text-accent hover:underline">
                  Tambah produk
                </Link>
              </div>
            )}
        ...
        {step === 5 && (
          <div className="animate-fade-in">
            ...
            <p className="text-slate-500 mb-6">Pilih cara menentukan topic konten</p>
            ...
            {!formData.topicMode && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-slate-800 mb-1">Tentukan topic sendiri</h3>
                  <p className="text-sm text-slate-500">Masukkan judul dan deskripsi topic konten</p>
                </button>
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-slate-800 mb-1">AI bantu carikan topic</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Jelaskan ide konten secara singkat..."
              ...
              <div className="space-y-4">
                ...
                {loadingTopics ? (
                  <div className="py-12 text-center">
                    ...
                    <p className="text-sm text-slate-400 mt-1">Berdasarkan pillar, produk, dan brand client</p>
                  </div>
                ) : topicsError ? (
      ...
      {step === 5 && formData.topicMode && (
        <div className="mt-6 bg-blue-50 rounded-xl p-4 border border-blue-100">
          <p className="text-blue-700 text-sm flex items-start gap-2">
            ...
            <span>
              Setelah klik "Buat Konten", konten akan dibuat di akun client dan bisa langsung di-develop dengan AI Assistant.
            </span>
          </p>
        </div>
      )}
